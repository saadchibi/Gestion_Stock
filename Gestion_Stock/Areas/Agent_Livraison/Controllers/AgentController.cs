...
namespace Gestion_Stock.Areas.Caissier.Controllers
{
    [Area("Agent_Livraison")]
    public class AgentController : Controller
    {
        private readonly IEmailSender _emailSender;
        private readonly ApplicationDbContext _db;
        private int PageSize = 2;
        public AgentController(ApplicationDbContext db, IEmailSender emailSender)
        {
            _db = db;
        ...
        public async Task<IActionResult> Confirm(int id)
        {
            ...
            {
                OrderHeader = await _db.OrderHeader.Include(o => o.Utilisateur).FirstOrDefaultAsync(o => o.Id == id && o.UserId == claim.Value),
        ...
        [Authorize(Roles = SD.Agent_Livraison + "," + SD.Admin)]
        ...
        public async Task<IActionResult> GetOrderDetails(int Id)
        {
            OrderDetailsViewModel orderDetailsViewModel = new OrderDetailsViewModel()
            {
                OrderHeader = await _db.OrderHeader.Include(el => el.Utilisateur).FirstOrDefaultAsync(m => m.Id == Id),
            ...
            return PartialView("_IndividualOrderDetailsAgent", orderDetailsViewModel);
        }




        [Authorize(Roles = SD.Caissier + "," + SD.Admin)]
        ...
        public async Task<IActionResult> OrderPickup(int productPage = 1, string searchEmail = null, string searchPhone = null, string searchName = null)
        {
            ...
            param.Append("/Agent_Livraison/Agent/OrderPickup?productPage=:");
            ...
            if (searchName != null || searchEmail != null || searchPhone != null)
            {
                ...
                if (searchName != null)
                {
                    OrderHeaderList = await _db.OrderHeader.Include(o => o.Utilisateur)
                ...
                else
                {
                    if (searchEmail != null)
                    {
                        user = await _db.Utilisateur.Where(u => u.Email.ToLower().Contains(searchEmail.ToLower())).FirstOrDefaultAsync();
                        OrderHeaderList = await _db.OrderHeader.Include(o => o.Utilisateur)
            ...
            {
                OrderHeaderList = await _db.OrderHeader.Include(o => o.Utilisateur).Where(u => u.Status == SD.StatusReady).ToListAsync();
            }
        ...
        public async Task<IActionResult> OrderPickupPost(int orderId)
        {
            ...
            return RedirectToAction("OrderPickup", "Agent");
        }
    }
}